...
expInfo = {'participant': 'test', 'session': '001', 'language': 'spanish'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\ning\\Documents\\python works\\psychopy_experiments\\word visual search\\scripts\\visual_search.py',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions(f'..\\data\\{expInfo["language"]}.csv'),
