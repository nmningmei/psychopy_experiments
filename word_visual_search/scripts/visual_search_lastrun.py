...
expInfo = {'participant': 'test', 'session': '001', 'language': 'mixed'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\ning\\Documents\\python_works\\psychopy_experiments\\word_visual_search\\scripts\\visual_search_lastrun.py',
